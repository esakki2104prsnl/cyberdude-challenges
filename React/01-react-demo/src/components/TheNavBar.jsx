  ...
  return (
    <div>
      <div className="mx-36 sm:mx-auto sm:flex sm:items-center justify-between px-2 sm:px-14 py-3">
        ...
        <div className="">
          {/* <ul className="flex flex-wrap  pl-10 justify-around  sm:justify-center space-x-2 sm:space-x-10"> */}
          <ul className="flex pl-5 space-x-4 justify-center mt-2 sm:flex sm:gap-x-6">
            <li>
        ...
        <div className="invisible sm:visible px-16">
          <Link
            target="_blank"
            to="https://github.com/esakki2104prsnl/cyberdude-challenges/tree/master/React/01-react-demo"
          >
            <svg
