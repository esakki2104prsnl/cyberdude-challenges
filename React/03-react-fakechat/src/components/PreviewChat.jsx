      ...
      <div>
        <div className="min-w-xl w-full font-semibold">
          <div className="border-2 m-3 p-3 bg-stone-200 z-10 shadow-2xl shadow-black rounded-md">
            {/* Header of Mobile */}
            <div className="bg-white flex items-baseline justify-between p-1 mx-14 px-4">
              <p>10:50</p>
            ...
            <div className="bg-white mx-14 px-2 pt-2">
              <div className="flex justify-between p-1">
                <div className="flex items-center space-x-3">
                  ...
                  <img
                    ...
                    alt="your dp preview"
                  />
                  <h1 className="font-bold text-lg">Sabari</h1>
                </div>
            ...
            {/* Main Chat */}
            <div className="bg-white mx-14 px-2 py-2 h-screen">
            ...
            {/* Msg Input */}
            <div className="bg-white mx-14 px-4 py-2 flex">
              <div className="flex p-2 space-x-3 items-center bg-stone-200 rounded-full">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="2em"
                  height="2em"
                ...
                <input type="text" name="msg" id="msg" className="outline-none bg-slate-100"/>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="2em"
                  height="2em"
              ...
              <div className="flex-1 mx-6 p-2 bg-green-700 rounded-full">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="2em"
                  height="2em"
