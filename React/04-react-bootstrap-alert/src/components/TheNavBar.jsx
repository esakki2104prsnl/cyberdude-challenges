...
const TheNavBar = () => {
  return (
    <div className="fixed bg-header z-10 left-0 top-0 right-0">
      <div className="flex justify-between items-center">
        <div className=" flex  items-center justify-between text-gray-200 font-bold p-2">
          ...
          <div className="flex items-center space-x-5 pl-5 text-md">
        ...
        <div className="p-5 mr-8 flex items-center space-x-5">
