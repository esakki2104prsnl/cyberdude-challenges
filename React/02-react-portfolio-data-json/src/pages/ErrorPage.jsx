...
const ErrorPage = () => {
  ...
  return (
    <div className="bg-black h-screen  mx-auto py-20 sm:py-60 ">
      <div className=" bg-red-500 max-w-xl mx-10 sm:mx-auto p-10 text-center shadow-md shadow-white rounded-md ">
