...
const About = () => {
  return (
    <div className=" p-5  flex-row space-y-20 rounded mx-5  sm:mx-auto sm:mt-16 text-center text-gray-900 font-semibold text-xl  max-w-xl  sm:pb-24   bg-[url('https://img.freepik.com/free-photo/social-media-concept-with-smartphone_52683-100042.jpg')] bg-no-repeat ">
      {/* Mail */}
      <h1 className="underline text-black font-bold pb-5">
        My Social Media Links
      </h1>
      <Link to="mailto:esakki2104prsnl@gmail.com" target="_blank">
        <div className="about-div hover:bg-slate-900 hover:text-yellow-600">
          <svg
          ...
          <h1>esakki2104prsnl@gmail.com</h1>
        </div>
      </Link>

      {/* Whatsapp */}
      <Link to="https://wa.me/+918300608634" target="_blank">
        <div className="about-div hover:bg-slate-900 hover:text-green-600">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="32"
            height="32"
      ...
      {/* Github */}
      <Link to="https://github.com/esakki2104prsnl" target="_blank">
        <div className="about-div hover:bg-slate-900 hover:text-white">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="32"
            height="32"
      ...
      <Link to="https://www.linkedin.com/in/esakki-m/" target="_blank">
        <div className="about-div hover:text-blue-600  hover:bg-slate-900">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="32"
            height="32"
      ...
      {/* Instgram */}
      <Link to="https://www.instagram.com/vj._.sabari._.2oo2/" target="_blank">
        <div className="about-div hover:text-pink-500 hover:bg-slate-900">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="32"
            height="32"
