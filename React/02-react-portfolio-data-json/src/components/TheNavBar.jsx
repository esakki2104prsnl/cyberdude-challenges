...
const TheNavBar = () => {
  return (
    <div>
      <div className=" sm:mx-auto sm:flex sm:items-center justify-between px-2 sm:px-14 py-3 ">
        <div className="text-center mx-auto flex items-center w-fit p-2">
          <img
        ...
        <>
          <ul className=" flex sm:pl-5 gap-x-2 justify-center mt-2 sm:flex sm:gap-x-6 ">
            <li>
        ...
        <div className="p-1 gap-5 sm:p-2 mx-auto  flex items-center w-fit space-x-1 sm:space-x-5">
