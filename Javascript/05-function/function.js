...
let resultDeclaration = addDeclaration(64, 32);
...
let resultExpression = addExpression(23, 7);
console.log(resultExpression); 

// Arrow Function Expression
const addArrow = (a, b) => a + b;
let resultArrow = addArrow(3, 17);
...
//Array of Object to hold quotes, sources, citaitons and years
const quotes = [
    {
    ...
    {
        quote: "I'm 21 years, you probably won't even remember this.",
        source: "Anonymous",
        citation: "Unknown Thoughts",
        year: "2020"
    },
    {
...
function printQuote() {
    ...
    const quoteString = `
    Quotes of the Day: "${quotes.quote}" 
        Source: ${quotes.source} 
        Citation: ${quotes.citation}
        Year:  ${quotes.year} 
        ` ;
